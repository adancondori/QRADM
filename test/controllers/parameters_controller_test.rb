...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post parameters_url, params: { parameter: { amount: @parameter.amount, description: @parameter.description, name: @parameter.name, state: @parameter.state, type: @parameter.type } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { amount: @parameter.amount, description: @parameter.description, name: @parameter.name, state: @parameter.state, type: @parameter.type } }
